...
local CREATOR_IDS = { [168519468] = true }
local PLACE_IDS = { [113236157544232] = true, [9797806474] = true }

if not CREATOR_IDS[game.CreatorId] and not PLACE_IDS[game.PlaceId] and not PLACE_IDS[game.GameId] then
	warn("[HMZ Hub] Unsupported game")
	return
end

local function hmzFail(msg)
	getgenv().HmzHub_Executed = nil
	warn("[HMZ Hub] " .. tostring(msg))
end
...
H.GameId = "anime_astral"
H.GameCfg = { Name = "Anime Astral" }
H.ConfigPath = "HMZHub/" .. H.GameId .. "/" .. game:GetService("Players").LocalPlayer.Name .. ".json"
...
H.buildUI()
H.restoreAll()
H.notify("HMZ Hub", "Loaded " .. H.GameCfg.Name, 5)
